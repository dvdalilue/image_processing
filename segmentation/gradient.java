...
public class gradient {
    public static void main(String[] args) {
        ...
        String file_output = args[0].substring(0, args[0].lastIndexOf('.')) + "_gradient" + args[0].substring(args[0].lastIndexOf('.'), args[0].length());

        BufferedImage visualBinary = VisualizeBinaryData.renderBinary(Segmentation.gradient(original), false, null);
