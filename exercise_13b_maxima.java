...
public class exercise_13b_maxima {
    public static void main(String[] args) {
        ...
        if (conectivity == 8) {
            img_gray8_aux = ImageProcessing.flatzoneRegion(img_gray8_ori, new EightConnectivity(), Region.Maxima);
        } else if (conectivity == 4) {      
            img_gray8_aux = ImageProcessing.flatzoneRegion(img_gray8_ori, new FourConnectivity(), Region.Maxima);
        }
